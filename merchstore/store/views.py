...
# Retrieve the product and its associated images
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if quantity > product.stock:
                ...
                return redirect('store:product_detail', num=product.id)  # Re-render the page with the error message
            else:
                ...
                return redirect('store:cart')  # Redirect to the cart after the purchase
